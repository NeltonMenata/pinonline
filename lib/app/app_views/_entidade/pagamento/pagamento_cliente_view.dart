...
class PagamentoClienteView extends StatelessWidget {
  PagamentoClienteController get _controller => PagamentoClienteController.controller;
  @override
                        ...
                        itemBuilder: (context, index) {
                          return Column(
                            ...
                            children: [
                              ...
                              Text("Descrição do Leilão: ${snapshot.data![index]["leilao"]["descricao"]}"),
                              SizedBox(
                                height: 200,
                                width: 200,
                                child: Image.network(snapshot.data![index]["comprovativo"]["url"].toString()))
                            ],
                          );
                        },
